...
const Merchant = require('../rp-merchant/Model')
...
const { checkerValidMerchant } = require('../rp-merchant/services')
const { checkerValidInstitution, institutionRelationChecker } = require('../rp-institution/services')
const { addBillingService } = require('../rp-billing/services')
const { addUserTransaction } = require('../rp-transaction/services')
