...
const createMeeting = {
  ...
  resolve (parent, args) {
    return createMeetingService(args.title, args.host, args.createdBy, args.startDate, args.endDate, args.permissionToJoin, args.limit, args.audio, args.video, args.socketId)
  }
}
