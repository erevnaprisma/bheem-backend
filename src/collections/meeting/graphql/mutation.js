...
const { CreateMeetingType, FinishMeetingType, AddParticipantType } = require('../graphql/type')
const { createMeetingService, finishMeetingService, addParticipantService } = require('../services')
